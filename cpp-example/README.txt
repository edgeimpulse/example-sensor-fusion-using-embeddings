...
# Edge Impulse library for Audio Sensor Fusion - Step 2

This is a C++ library that lets you run the impulse for "Audio Sensor Fusion - Step 2" (http://localhost:4800/studio/299865) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
